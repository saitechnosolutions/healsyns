...
<section class="contact footer-padding" style="padding-top:15px;">
    <div class="container">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="wrapper phone">
                                            <div class="wrapper-img">
                                                <span>
                                                    <svg width="44" height="44" viewBox="0 0 44 44" fill="none"
                                                        ...
                                                        <circle cx="22" cy="22" r="21.5" stroke="#23989f"></circle>
                                                        <path
                                                            ...
                                                            fill="#23989f" stroke="#23989f"></path>
                                                        <path
                                            ...
                                            <div class="wrapper-content">
                                                ...
                                                <p class="paragraph"><a href="tel:+91 8610809690">+91 8610809690</a></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="wrapper phone">
                                            ...
                                            <div class="wrapper-content">
                                                ...
                                                <p class="paragraph"><a href="mailto:narmatha.doc@gmail.com">narmatha.doc@gmail.com</a></p>
                                        ...
                                        <div class="address">
                                            <div class="contact-address">
                                                    ...
                                                    <span>
                                                        <svg width="44" height="44" viewBox="0 0 44 44" fill="none"
                                                            ...
                                                            <path
                                                                ...
                                                                fill="#23989f" stroke="#23989f"></path>
                                                            <circle cx="22" cy="22" r="21.5" stroke="#23989f">
                                                            </circle>
                                                        </svg>
                                                    </span>
                                                </div>
                                                <div class="address-content">
                                                    ...
                                                    <p class="paragraph">Healthsyns Biocorp Pvt Ltd, 30, 6th Cross, Bharathi Park, Saibaba Colony, Coimbatore - 641011</p>
                                                </div>
                                            </div>
                ...
                <div class="col-lg-6">
                    <div class="question-section login-section ">
                        ...
                        <div class="review-form">
                            ...
                            <form id="basic_form"  action="/sendmail" method="POST">
                                @csrf
                            <div class=" account-inner-form">
                                <div class="review-form-name">
                                    <label for="fname" class="form-label">Name*</label>
                                    <input type="text" name="name" id="basic_name" value="" class="form-control" placeholder="Name" required="">

                                </div>
                                <div class="review-form-name">
                                    <label for="email" class="form-label">Email*</label>
                                    <input type="text" name="email"  id="basic_email" value="" class="form-control" placeholder="Email" required="">

                                </div>
                                <div class="review-form-name">
                                    <label for="phone" class="form-label">Phone*</label>
                                    <input type="text" id="basic_phone" name="phone" value="" class="form-control" placeholder="Phone" required>

                                </div>
                            </div>
                            <div class="review-textarea">
                                <label for="advanced-usage_message" >Message*</label>
                                <textarea class="form-control"  name="message" class="form-control" placeholder="Write Message..........."
                                id="basic_message" rows="3"></textarea>
                            </div>
                            <button class="shop-btn" type="submit" data-loading-text="Please wait..." >
...
<script>
    const addValidator = new JustValidate("#basic_form", {
  ...
  .addField('#basic_message', [
    ...
    },
   {
        ...
        },
        {
          rule: 'maxLength',
          value: 200,
          message: 'Message can be at most 10 characters long.',
        },
        {
    rule: 'customRegexp',
    value: /^[a-zA-Z]+$/,
    errorMessage: 'Message should contain only letters'
},
  ])
